...
chrome = webdriver.Chrome(service=s) #definim variabila care va stoca driverul de chrome
...
chrome.find_element(By.XPATH, '//*[@type="first-name"]').send_keys('n')  #  * inseamna un inlocuitor pentru toate elementele care respecta regula
