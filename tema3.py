...
echipa=['Hagi', 'Petrescu', 'Munteanu', 'Ilie', 'Mutu']
schimbari_efectuate=['Ganea', 'Popescu', 'Stelea']

print('Echipa este formata din', len(echipa), 'jucatori:', echipa)
print('Rezervele sunt urmatorii', len(schimbari_efectuate), 'jucatori:', schimbari_efectuate)
